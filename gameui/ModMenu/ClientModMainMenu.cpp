...
ClientModMainMenu::ClientModMainMenu( vgui::Panel *parent ): vgui::PropertyPage( parent, "ClientModMainMenu" )
{
	...
	m_pViewbobStyle->AddItem( "#GameUI_Gameplay_Viewbob_CSS", "cmod_new_bobbing 0" );
	m_pViewbobStyle->AddItem( "#GameUI_Gameplay_Viewbob_CSGO", "cmod_new_bobbing 1" );
...
void ClientModMainMenu::OnResetData()
{
	...
	ConVarRef cl_use_new_headbob( "cmod_new_bobbing" );

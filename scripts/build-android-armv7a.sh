...
./waf configure -T release --build-game=hl2 --prefix=Srceng-mod-launcher/android --android=armeabi-v7a-hard,host,21 --target=../armeabi-v7a --enable-opus --togles --disable-warns &&
./waf install  --strip
